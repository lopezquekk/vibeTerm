...
pub fn is_main_thread() -> bool {
  // +[NSThread isMainThread] can return false on macOS 15 (Sequoia) during
  // applicationDidFinishLaunching. Use pthread_main_np() which reliably
  // checks if we're on the initial process thread.
  extern "C" {
